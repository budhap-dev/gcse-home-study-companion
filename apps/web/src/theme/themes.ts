...
export const THEMES: Theme[] = [
  ...
  { id: 'candy', name: 'Candy', blurb: 'Pink and lilac. Loud on purpose.', vars: { '--color-paper': '#fdf0f7', '--color-surface': '#fffafd', '--color-ink': '#3b1e33', '--color-ink-2': '#7c4f70', '--color-ink-3': '#ab86a1', '--color-rule': '#f2d3e6', '--color-panel': '#f9e0ef', '--bg-pattern': "radial-gradient(circle at 20% 30%, #f8c8e4 0 6px, transparent 7px), radial-gradient(circle at 70% 80%, #e6d4f5 0 8px, transparent 9px)", '--bg-size': '180px 180px' } },
  { id: 'space', name: 'Space', blurb: 'Stars on deep navy. For night-time missions.', dark: true,
    vars: { '--color-paper': '#0f1530', '--color-surface': '#1a2145', '--color-ink': '#f1f3ff', '--color-ink-2': '#b9c0e6', '--color-ink-3': '#7f89bd', '--color-rule': '#2c3663', '--color-panel': '#232c55', '--subject-soft': '#2a3466', '--bg-pattern': "radial-gradient(circle at 10% 20%, #ffffff 0 1px, transparent 2px), radial-gradient(circle at 60% 70%, #ffffff 0 1.5px, transparent 2.5px), radial-gradient(circle at 85% 15%, #ffe9a8 0 1px, transparent 2px), radial-gradient(circle at 35% 85%, #ffffff 0 1px, transparent 2px)", '--bg-size': '220px 220px' } },
  { id: 'jungle', name: 'Jungle', blurb: 'Leafy greens and a splash of sun.', vars: { '--color-paper': '#eef7ea', '--color-surface': '#ffffff', '--color-ink': '#1d3320', '--color-ink-2': '#4f6f52', '--color-ink-3': '#84a087', '--color-rule': '#cfe3cc', '--color-panel': '#dcefd8', '--bg-pattern': "radial-gradient(ellipse at 15% 25%, #cfe9c5 0 14px, transparent 15px), radial-gradient(ellipse at 80% 70%, #ffe8a3 0 10px, transparent 11px)", '--bg-size': '260px 260px' } },
  { id: 'sunshine', name: 'Sunshine', blurb: 'Bright yellow, big smiles.', vars: { '--color-paper': '#fff8dc', '--color-surface': '#fffdf3', '--color-ink': '#3a2f0b', '--color-ink-2': '#7a6a2c', '--color-ink-3': '#a89a63', '--color-rule': '#f3e5a8', '--color-panel': '#fdf0bb', '--bg-pattern': "radial-gradient(circle at 25% 25%, #ffe680 0 10px, transparent 11px), radial-gradient(circle at 75% 75%, #ffd166 0 6px, transparent 7px)", '--bg-size': '200px 200px' } },
]
