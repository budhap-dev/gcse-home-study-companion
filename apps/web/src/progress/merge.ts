 ...
 * keeping the fuller deck run, minutes take the larger figure per day (both copies may
 * already contain the same session), days off and badges are united, and a goal the device
