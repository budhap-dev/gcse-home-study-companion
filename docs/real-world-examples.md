...
**Status: rolled out to eight of nine subjects.** Requested 18 September 2026 and proved first on Physics *Moments, levers and gears*. As of 24 September 2026 every Maths, Physics, Chemistry, Biology, Computer Science, Business, Music and French topic carries the block; Further Maths carries it on the sixteen topics written from 24 September, and the three earlier calculus topics will get it when the subject is finished. Music, expected to be thin, was not: every one of its 19 topics carries examples, because *why does this form exist* and *what is the exam actually paying for* turned out to be the questions a set work most needs answered. French, expected to be thinner still, was not either: its 50 topics carry 150 examples, because a language topic is met in a situation (the form at the campsite, the sign on the museum door, the group chat on Friday) and pays in the exam for one piece of grammar, and both can be pictured in a short table or, for a tense, a `verb-table` with the stem drawn apart from the endings. The rest of this document is the design, corrected where building it showed the design was wrong.
...
0. ~~**Build `size-compare` first**, and prove the design on one topic end to end.~~ **Done.** `size-compare` exists, the `why` field is on `Topic`, the card renders on the topic page, and Physics *Moments, levers and gears* is written. Read that one before writing another. As of 24 September 2026 Maths, Physics, Chemistry, Biology, Computer Science, Business, Music and French carry the section on every topic; Further Maths does not yet.
