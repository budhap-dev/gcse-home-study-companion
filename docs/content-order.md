...
|---|---|---|---|
| Mathematics | — | 16: Choices and outcomes · Circle theorems · Combined events and tree diagrams · Congruent triangles · Constructing triangles · Equations of straight lines · Expanding and factorising quadratics · Identities and rearranging formulae · Laws of indices · Parallel and perpendicular lines · Powers and roots · Sample space diagrams · Sets and set notation · Solving quadratic equations · Surds · Venn diagrams | — |
...
| Spring 1 | Combined events and tree diagrams · Sample space diagrams · Venn diagrams · Choices and outcomes · Sets and set notation · Histograms · Linear, quadratic and geometric sequences · Iteration | The five probability and sets topics drafted 14 September 2026 (Sample space diagrams · Combined events and tree diagrams · Venn diagrams · Choices and outcomes · Sets and set notation). Histograms, sequences and iteration still to come. |
