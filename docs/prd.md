...
| Music | Edexcel 1MU0 | Untiered | Musical elements and language · Instrumental music 1700–1820 · Vocal music · Music for stage and screen · Fusions | Component 3 Appraising only: 1 h 45, 80 marks, 40%. Composing and performing are coursework, so there is nothing to revise. No audio is bundled — the set works are in copyright — and no timings are printed, since they cannot be checked against a recording. Unfamiliar extracts are described in prose. |
